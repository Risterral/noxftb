...
public class AcceptTradesCommand implements CommandExecutor {

    private static String CONFIRM_INFO = "You are now accepting trades.";

    private Plugin plugin;

    public AcceptTradesCommand(Plugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] split) {
        ...
        playerDto.setAcceptingTrades(true);
